...
func NewStorageManager() (*StorageManager, error) {
	...
	candidates := []string{
		filepath.Join(cwd, ".tuya-data"),
		filepath.Join(os.Getenv("LOCALAPPDATA"), "tuya-ipc-terminal", ".tuya-data"),
		filepath.Join(os.Getenv("USERPROFILE"), ".tuya-data"),
		filepath.Join(cwd, "..", ".tuya-data"),
	}
	...
	if dataDir == "" {
		// Default to cwd/.tuya-data (will be created)

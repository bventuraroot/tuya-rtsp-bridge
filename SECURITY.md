...
This project talks to unofficial Tuya / iSmartLife web APIs and local device port 6668.

- Do not commit `%APPDATA%\TuyaRtspBridge` (cookies, `localKey`, device lists).

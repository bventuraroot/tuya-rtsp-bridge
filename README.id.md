...
2. Python 3.10+ (Windows: centang **Add to PATH**)
3. Akun Smart Life / Tuya Smart yang sudah melihat kameranya
4. Opsional: VLC untuk pratinjau

Windows: `TuyaRtspBridge-Setup.exe` dari [Releases](../../releases) — pilih bahasa.  

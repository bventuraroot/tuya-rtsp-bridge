...
2. Python 3.10+ (Windows: zaznacz **Add to PATH**)
3. Konto Smart Life / Tuya Smart, które już widzi kamery
4. Opcjonalnie: VLC do podglądu

Windows: `TuyaRtspBridge-Setup.exe` z [Releases](../../releases) — wybierz język.  

...
Duplo clique **TuyaRtspBridge-Setup.exe** en [Releases](https://github.com/DanEng1982/tuya-rtsp-bridge/releases).
...
Login: `%APPDATA%\TuyaRtspBridge\`. SmartScreen: **Más información → Executar mesmo assim**.
